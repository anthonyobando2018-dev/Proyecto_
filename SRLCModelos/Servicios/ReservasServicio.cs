...
{
    public static class ReservasServicio
    {
        ...
        {
            DocentesServicio.BuscarDocente(reserva.IdDocente);
            Laboratorio lab = LaboratoriosServicio.BuscarLaboratorio(reserva.IdLaboratorio);
        ...
        public static List<Reserva> FiltrarPorLaboratorio(int idLaboratorio)
        {
            List<Reserva> listaFiltrada = ListarReservas();
            listaFiltrada = listaFiltrada.FindAll((reserva) => reserva.IdLaboratorio == idLaboratorio);
            return listaFiltrada;
        }

        public static List<Reserva> FiltrarPorFecha(DateOnly fechaInicio, DateOnly? fechaFin = null)
        {
            List<Reserva> listaFiltrada = ListarReservas();
        ...
        private static void ValidarSolapamiento(Reserva reserva)
        {
            ...
            var listaFiltrada = _listaReservas.FindAll((res) => reserva.IdLaboratorio == res.IdLaboratorio && reserva.FechaReserva == res.FechaReserva);
