...
namespace SRLCModelos.Utilidades
{
    ...
    public static class Validaciones
    {
        ...
        {
            if (numero < valorMinimo) throw new ArgumentOutOfRangeException($"El valor de {campoNombre} debe ser como minimo {valorMinimo}!");
            if (numero > valorMaximo) throw new ArgumentOutOfRangeException($"El valor de {campoNombre} tiene que ser mayor que {valorMaximo}!");
        }
    }
}
